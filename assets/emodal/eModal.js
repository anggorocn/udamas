    ...
    define(['jquery'], function ($, root) {
        ...
        function _getFooter(buttons) {
            ...
            if (buttons) {
                ...
                extension = ifile.slice((ifile.lastIndexOf(".") - 1 >>> 0) + 2);
                extension = extension.toUpperCase();
                //if no buttons defined by user, add a standard close button.
                messageFotter.append('<button class="x btn btn-danger" style="text-align:center" data-dismiss=modal type=button>  <i class="fa fa-times fa-lg"></i> CLOSE </button>');
                if(extension=="PDF" || extension=="JPG" || extension=="PNG" || extension=="JPEG" || extension=="BMP"){
                 messageFotter.append('<button class="btn btn-primary" style="text-align:center" onclick="downloadDialogFile()"  type=button> <i class="fa fa-download fa-lg"></i> DOWNLOAD </button>');
                }
               //  messageFotter.append('<a class="btn btn-primary" style="text-align:center" href="'+ifile+'" download="file.pdf"  type=button> <i class="fa fa-download fa-lg"></i> DOWNLOAD </a>');
        ...
        function alert(data, title) {
            ...
            var $message = $(div).append(_getMessage(data), _getFooter());
         ...
         * @returns {Promise} Promise with modal $DOM element
         */
        function iframe(params, title,filename) {
            var dfd = _createDeferred();
            var html = ('<div class=modal-body style="position: absolute;width: 100%;background-color: rgba(255,255,255,0.8);height: 100%;">%1%</div>' +
                        '<iframe id="modalFrame" class="embed-responsive-item" frameborder=0 src="%0%" style="width:100%;height:75vh;display:block;"/>')
