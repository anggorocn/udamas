  ...
  <div class="col-md-12">
    ...
    <div class="area-panel">
      ...
      <form class="needs-validation form-horizontal" id="ff" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="">Triwulan: </label>
          <div class="col-sm-4">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <ol>
            ...
            <li> 
               <div class="form-group">
                <label class="control-label col-sm-2" for="">Kuadrat Predikat Kinerja</label>
                <div class="col-sm-8">
             ...
             <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Capaian Organisasi : </label>
                <div class="col-sm-8">
                <select id="reqCapaianOrganisasi" name="reqCapaianOrganisasi" class="form-control">
                   <option value="" ></option>
                    <?
