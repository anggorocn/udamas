...
$arrgetaksesmenu= ["key"=>"orang_tua_add"];
...
// pakem data validasi
$arrparam= ["token"=>$sessPersonalToken, "vurl"=>"Orang_tua_json", "id"=>$reqId, "rowid"=>$reqRowId];
$set= new DataCombo();
...
// $reqTglLahirAyah= dateToPageCheck($ayah->getField('TANGGAL_LAHIR')); $vTglLahirAyah= checkwarna($reqPerubahanData, 'TANGGAL_LAHIR', [date]);

// $reqTglLahirIbu= dateToPageCheck($ibu->getField('TANGGAL_LAHIR')); $vTglLahirIbu= checkwarna($reqPerubahanData, 'TANGGAL_LAHIR', [date]);
