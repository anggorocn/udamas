...
$arrdataField= [];
$arrparam= ["token"=>$sessPersonalToken, "vurl"=>"Penilaian_detail_skp_json", "id"=>$reqId, "rowid"=>$reqRowId];
$set= new DataCombo();
...
while($set->nextRow())
{
  ...
  $reqPegawaiJenisJabatan = $set->getField('JENIS_JABATAN_DINILAI');$vPegawaiJenisJabatan= checkwarna($reqPerubahanData, 'JENIS_JABATAN_DINILAI');
  $reqPegawaiUnorNama = $set->getField('PEGAWAI_UNOR_NAMA');$vPegawaiUnorNama= checkwarna($reqPerubahanData, 'PEGAWAI_UNOR_NAMA');
  $reqPegawaiUnorId = $set->getField('PEGAWAI_UNOR_ID');$vPegawaiUnorId= checkwarna($reqPerubahanData, 'PEGAWAI_UNOR_ID');
  ...
  $reqPenilaianSkpPenilaiId = $set->getField("PEGAWAI_PEJABAT_PENILAI_ID"); $vPenilaianSkpPenilaiId= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_ID');
  $reqPenilaianSkpPenilaiNama = $set->getField('PEGAWAI_PEJABAT_PENILAI_NAMA');$vPenilaianSkpPenilaiNama= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_NAMA');
  $reqPenilaianSkpPenilaiNip = $set->getField('PEGAWAI_PEJABAT_PENILAI_NIP');$vPenilaianSkpPenilaiNip= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_NIP');
  $reqPenilaianSkpPenilaiJabatanNama = $set->getField('PEGAWAI_PEJABAT_PENILAI_JABATAN_NAMA');$vPenilaianSkpPenilaiJabatanNama= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_JABATAN_NAMA');
  $reqPenilaianSkpPenilaiUnorNama = $set->getField('PEGAWAI_PEJABAT_PENILAI_UNOR_NAMA');$vPenilaianSkpPenilaiUnorNama= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_UNOR_NAMA');
  $reqPenilaianSkpPenilaiPangkatId = $set->getField('PEGAWAI_PEJABAT_PENILAI_PANGKAT_ID');$vPenilaianSkpPenilaiPangkatId= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_PANGKAT_ID');
  $reqPenilaianSkpAtasanId = $set->getField("PEGAWAI_ATASAN_PEJABAT_ID");$vPenilaianSkpAtasanId= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_ID');
  $reqPenilaianSkpAtasanNama = $set->getField('PEGAWAI_ATASAN_PEJABAT_NAMA');$vPenilaianSkpAtasanNama= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_NAMA');
  $reqPenilaianSkpAtasanNip = $set->getField('PEGAWAI_ATASAN_PEJABAT_NIP');$vPenilaianSkpAtasanNip= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_NIP');
  $reqPenilaianSkpAtasanJabatanNama = $set->getField('PEGAWAI_ATASAN_PEJABAT_JABATAN_NAMA');$vPenilaianSkpAtasanJabatanNama= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_JABATAN_NAMA');
  $reqPenilaianSkpAtasanUnorNama = $set->getField('PEGAWAI_ATASAN_PEJABAT_UNOR_NAMA');$vPenilaianSkpAtasanUnorNama= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_UNOR_NAMA');
  $reqPenilaianSkpAtasanPangkatId = $set->getField('PEGAWAI_ATASAN_PEJABAT_PANGKAT_ID');$vPenilaianSkpAtasanPangkatId= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_PANGKAT_ID');

//Semester 2
  $reqPegawaiJenisJabatan2 = $set->getField('JENIS_JABATAN_DINILAI2');$vPegawaiJenisJabatan2= checkwarna($reqPerubahanData, 'JENIS_JABATAN_DINILAI2');
  $reqPegawaiUnorNama2 = $set->getField('PEGAWAI_UNOR_NAMA2');$vPegawaiUnorNama2= checkwarna($reqPerubahanData, 'PEGAWAI_UNOR_NAMA2');
  $reqPegawaiUnorId2 = $set->getField('PEGAWAI_UNOR_ID2');$vPegawaiUnorId2= checkwarna($reqPerubahanData, 'PEGAWAI_UNOR_ID2');

  $reqPenilaianSkpPenilaiId2 = $set->getField("PEGAWAI_PEJABAT_PENILAI_ID2");$vPenilaianSkpPenilaiId2= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_ID2');
  $reqPenilaianSkpPenilaiNama2 = $set->getField('PEGAWAI_PEJABAT_PENILAI_NAMA2');$vPenilaianSkpPenilaiNama2= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_NAMA2');
  $reqPenilaianSkpPenilaiNip2 = $set->getField('PEGAWAI_PEJABAT_PENILAI_NIP2');$vPenilaianSkpPenilaiNip2= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_NIP2');
  $reqPenilaianSkpPenilaiJabatanNama2 = $set->getField('PEGAWAI_PEJABAT_PENILAI_JABATAN_NAMA2');$vPenilaianSkpPenilaiJabatanNama2= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_JABATAN_NAMA2');
  $reqPenilaianSkpPenilaiUnorNama2 = $set->getField('PEGAWAI_PEJABAT_PENILAI_UNOR_NAMA2');$vPenilaianSkpPenilaiUnorNama2= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_UNOR_NAMA2');
  $reqPenilaianSkpPenilaiPangkatId2 = $set->getField('PEGAWAI_PEJABAT_PENILAI_PANGKAT_ID2');$vPenilaianSkpPenilaiPangkatId2= checkwarna($reqPerubahanData, 'PEGAWAI_PEJABAT_PENILAI_PANGKAT_ID2');

  $reqPenilaianSkpAtasanId2 = $set->getField("PEGAWAI_ATASAN_PEJABAT_ID2");$vPenilaianSkpAtasanId2= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_ID2');
  $reqPenilaianSkpAtasanNama2 = $set->getField('PEGAWAI_ATASAN_PEJABAT_NAMA2');$vPenilaianSkpAtasanNama2= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_NAMA2');
  $reqPenilaianSkpAtasanNip2 = $set->getField('PEGAWAI_ATASAN_PEJABAT_NIP2');$vPenilaianSkpAtasanNip2= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_NIP2');
  $reqPenilaianSkpAtasanJabatanNama2 = $set->getField('PEGAWAI_ATASAN_PEJABAT_JABATAN_NAMA2');$vPenilaianSkpAtasanJabatanNama2= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_JABATAN_NAMA2');
  $reqPenilaianSkpAtasanUnorNama2 = $set->getField('PEGAWAI_ATASAN_PEJABAT_UNOR_NAMA2');$vPenilaianSkpAtasanUnorNama2= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_UNOR_NAMA2');
  $reqPenilaianSkpAtasanPangkatId2 = $set->getField('PEGAWAI_ATASAN_PEJABAT_PANGKAT_ID2');$vPenilaianSkpAtasanPangkatId2= checkwarna($reqPerubahanData, 'PEGAWAI_ATASAN_PEJABAT_PANGKAT_ID2');
...
//Nilai SKP Tahun > 2022
  ...
  $reqNilaiHasilKerja= $set->getField('NILAI_HASIL_KERJA'); $vNilaiHasilKerja= checkwarna($reqPerubahanData, 'NILAI_HASIL_KERJA');
  $reqNilaiPerilakuKerja= $set->getField('NILAI_HASIL_PERILAKU'); $vNilaiPerilakuKerja= checkwarna($reqPerubahanData, 'NILAI_HASIL_PERILAKU');
  ...
  $reqCapaianOrganisasi= $set->getField('NILAI_CAPAIAN_ORGANISASI'); $vCapaianOrganisasi= checkwarna($reqPerubahanData, 'NILAI_CAPAIAN_ORGANISASI');
...
//   $reqSatkerAtasan = $pegawai_dinilai->getField('SATKER_ID_ATASAN');
 ...
 $reqValRowId= $set->getField("PENILAIAN_SKP_DETIL_ID");
...
{
  $arrdata= [];
  $arrdata["id"]= $set->getField("NILAI_KUADRAN_ID");
  $arrdata["text"]= $set->getField("NAMA");
  array_push($arrNilaiKuadran, $arrdata);
}

$arrCapaianOrganisasi= [];
$set->selectby($sessPersonalToken, "capainorganisasi", $arrdata);
while($set->nextRow())
{
  $arrdata= [];
  $arrdata["id"]= $set->getField("ID");
  $arrdata["text"]= $set->getField("NAMA");
  array_push($arrCapaianOrganisasi, $arrdata);
}
...
$set2= new DataCombo();
$set2->selectdata($arrparam, "");
$arrDataField = $set2->rowResult;
...
$(function(){
  ...
  $(document).on('submit', '#ff', function(){
    ...
    var formData = new FormData(dataform); 
      $.ajax({
        url:"api/Penilaian_skp_detil_json/add"
        , type: 'POST'
        , data:formData
        , dataType: 'json'
        ,processData: false
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="">Tahun
            <?
              ...
              ?>: </label>
          <div class="col-sm-4">
            <input type="text" readonly class="form-control easyui-validatebox <?=$warnaclass?>" id="reqTahun" name="reqTahun" placeholder="Isikan Tahun" value="<?=$reqTahun?>">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-2" for="">Triwulan
            <?
            $warnadata= $vTriwulan['data'];
            $warnaclass= $vTriwulan['warna'];
            if(!empty($warnadata))
            {
              ?>
              <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
          ...
          ?>: </label>
          <div class="col-sm-4">
             <select id="reqTriwulan"   name="reqTriwulan" class="form-control <?=$warnaclass?>" required>
         ...
         <div class="form-group">
          ...
          <ol>
            <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Nama
                  <?
                  $warnadata= $vPenilaianSkpDinilaiNama['data'];
                  $warnaclass= $vPenilaianSkpDinilaiNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text"  class="form-control easyui-validatebox <?=$warnaclass?>"  id="reqPenilaianSkpDinilaiNama" name="reqPenilaianSkpDinilaiNama" readonly placeholder="Isikan Nama" value="<?=$reqPenilaianSkpDinilaiNama?>">
                </div>
              </div>
            </li>
            <li> 
               <div class="form-group">
                ...
                <?
                  $warnadata= $vPenilaianSkpDinilaiNip['data'];
                  $warnaclass= $vPenilaianSkpDinilaiNip['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text"  class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpDinilaiNip" name="reqPenilaianSkpDinilaiNip" placeholder="Isikan Nip" readonly value="<?=$reqPenilaianSkpDinilaiNip?>">
                </div>
              </div>
            </li>
            <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Jenis Jabatan PNS Yang Dinilai
                  <?
                  $warnadata= $vPegawaiJenisJabatan['data'];
                  $warnaclass= $vPegawaiJenisJabatan['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <select id="reqPegawaiJenisJabatan" name="reqPegawaiJenisJabatan" class="form-control <?=$warnaclass?>" >
            ...
            <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Unit Kerja PNS Yang Dinilai
                <?
                  $warnadata= $vPegawaiUnorNama['data'];
                  $warnaclass= $vPegawaiUnorNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                <div class="col-sm-8">
                  ...
                  <input type="text" required class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPegawaiUnorNama" name="reqPegawaiUnorNama" placeholder="Isikan Unit Kerja PNS Yang Dinilai" value="<?=$reqPegawaiUnorNama?>">
                </div>
              </div>
            </li>
          </ol>
          ...
          <ol>
            <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Nip
                 <?
                  $warnadata= $vPenilaianSkpPenilaiNip['data'];
                  $warnaclass= $vPenilaianSkpPenilaiNip['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text" required class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpPenilaiNip" name="reqPenilaianSkpPenilaiNip" placeholder="Isikan Nip" value="<?=$reqPenilaianSkpPenilaiNip?>">
                </div>
              </div>
            </li>
            <li> 
               <div class="form-group">
                <label class="control-label col-sm-2" for="">Nama
                 <?
                  $warnadata= $vPenilaianSkpPenilaiNama['data'];
                  $warnaclass= $vPenilaianSkpPenilaiNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text" readonly class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpPenilaiNama" name="reqPenilaianSkpPenilaiNama" placeholder="Isikan Nama" value="<?=$reqPenilaianSkpPenilaiNama?>">
                </div>
              </div>
            </li>
            <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Jabatan Ketika Menilai
                  <?
                  $warnadata= $vPenilaianSkpPenilaiJabatanNama['data'];
                  $warnaclass= $vPenilaianSkpPenilaiJabatanNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                <div class="col-sm-8">
                  ...
                  <input type="text" required class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpPenilaiJabatanNama" name="reqPenilaianSkpPenilaiJabatanNama" placeholder="Isikan Jabatan Ketika Menilai" value="<?=$reqPenilaianSkpPenilaiJabatanNama?>">
                </div>
              </div>
            </li>
            <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Unit Kerja Ketika Menilai
                  <?
                  $warnadata= $vPenilaianSkpPenilaiUnorNama['data'];
                  $warnaclass= $vPenilaianSkpPenilaiUnorNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text" required class="form-control easyui-validatebox <?= $warnaclass?>" id="reqPenilaianSkpPenilaiUnorNama" name="reqPenilaianSkpPenilaiUnorNama" placeholder="Isikan Unit Kerja Ketika Menilai" value="<?=$reqPenilaianSkpPenilaiUnorNama?>">
                </div>
              </div>
            </li>
             <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Gol/Ruang Ketika Menilai
                 <?
                 $warnadata= $vPenilaianSkpPenilaiPangkatId['data'];
                 $warnaclass= $vPenilaianSkpPenilaiPangkatId['warna'];
                 if(!empty($warnadata))
                 {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                : </label>
                <div class="col-sm-8">
                  <select name="reqPenilaianSkpPenilaiPangkatId" id="reqPenilaianSkpPenilaiPangkatId" class="form-control <?=$warnaclass?>" >
                    <option value=""></option>
                    <?
          ...
          <ol>
            <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Nip
                <?
                 $warnadata= $vPenilaianSkpAtasanNip['data'];
                 $warnaclass= $vPenilaianSkpAtasanNip['warna'];
                 if(!empty($warnadata))
                 {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text" required class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpAtasanNip" name="reqPenilaianSkpAtasanNip" placeholder="Isikan Nip" value="<?=$reqPenilaianSkpAtasanNip?>">
                </div>
              </div>
            </li>
            <li> 
            ...
            <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Jabatan Ketika Menandatangani
                  <?
                  $warnadata= $vPenilaianSkpAtasanJabatanNama['data'];
                  $warnaclass= $vPenilaianSkpAtasanJabatanNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text" required class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpAtasanJabatanNama" name="reqPenilaianSkpAtasanJabatanNama" placeholder="Isikan Jabatan Ketika Menandatangani" value="<?=$reqPenilaianSkpAtasanJabatanNama?>">
                </div>
              </div>
            </li>
            <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Unit Kerja Ketika Menandatangani
                <?
                  $warnadata= $vPenilaianSkpAtasanUnorNama['data'];
                  $warnaclass= $vPenilaianSkpAtasanUnorNama['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                  <input type="text" required class="form-control easyui-validatebox <?=$warnaclass?>" id="reqPenilaianSkpAtasanUnorNama" name="reqPenilaianSkpAtasanUnorNama" placeholder="Isikan Unit Kerja Ketika Menandatangani" value="<?=$reqPenilaianSkpAtasanUnorNama?>">
                </div>
              </div>
            </li>
             <li> 
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Gol/Ruang Ketika Menandatangani
                  <?
                  $warnadata= $vPenilaianSkpAtasanPangkatId['data'];
                  $warnaclass= $vPenilaianSkpAtasanPangkatId['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                   <select name="reqPenilaianSkpAtasanPangkatId" id="reqPenilaianSkpAtasanPangkatId" class="form-control <?=$warnaclass?>" >
                    <option value=""></option>
                     <?
                    foreach ($arrPangkat as $key => $value)
                    {
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <ol>
            <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Nilai Hasil Kerja  
                  <?
                  $warnadata= $vNilaiHasilKerja['data'];
                  $warnaclass= $vNilaiHasilKerja['warna'];
                  if(!empty($warnadata))
                  {
                    ?>
                    <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                ?>: </label>
                <div class="col-sm-8">
                <select id="reqNilaiHasilKerja" name="reqNilaiHasilKerja" class="form-control <?=$warnaclass?>">
             ...
             <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Nilai Perilaku Kerja 
                 <?
                 $warnadata= $vNilaiPerilakuKerja['data'];
                 $warnaclass= $vNilaiPerilakuKerja['warna'];
                 if(!empty($warnadata))
                 {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
              ...
              ?> : </label>
                <div class="col-sm-8">
              <select id="reqNilaiPerilakuKerja" name="reqNilaiPerilakuKerja" class="form-control <?=$warnaclass?>">
            ...
            <li> 
               <div class="form-group">
                <label class="control-label col-sm-2" for="">Kuadrat Predikat Kinerja 
                  <?
                 $warnadata= $vNilaiPerilakuKerja['data'];
                 $warnaclass= $vNilaiPerilakuKerja['warna'];
                 if(!empty($warnadata))
              ...
              ?>:</label>
                <div class="col-sm-8">
                  ...
                  <!-- <input type="text"  readonly class="color-disb"  id="reqKuadratPredikatKinerjaNama" name="reqKuadratPredikatKinerjaNama" value=""/> -->
                    <input placeholder type="text" class="form-control" id="reqKuadratPredikatKinerjaNama" name="reqKuadratPredikatKinerjaNama" value="" readonly />
                </div>
              </div>
            </li>
             <li>   
              <div class="form-group">
                <label class="control-label col-sm-2" for="">Capaian Organisasi 
                 <?
                 $warnadata= $vCapaianOrganisasi['data'];
                 $warnaclass= $vCapaianOrganisasi['warna'];
                 if(!empty($warnadata))
                 {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
              ...
              ?>: </label>
                <div class="col-sm-8">
                <select id="reqCapaianOrganisasi" name="reqCapaianOrganisasi" class="form-control <?=$warnaclass?>">
                   <option value="" ></option>
                    <?
                    foreach ($arrCapaianOrganisasi as $key => $value)
                    {
                      $optionid= $value["id"];
                      $optiontext= $value["text"];
                      $optionselected= "";
                      if($reqCapaianOrganisasi == $optionid)
                        $optionselected= "selected";
                      ?>
                      <option value="<?=$optionid?>" <?=$optionselected?>><?=$optiontext?></option>
                      <?
...
<script type="text/javascript">
  ...
  function loadNilaiKuadran(){
    ...
    $.get("api/Penilaian_kinerja_json/comboNilaiKuadran?reqId="+kode )
    .done(function( data ) {
      var reqkode = '';
      var reqkodeNama = '';
