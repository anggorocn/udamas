...
$arrjenisiddokumen= [];
$set= new DataCombo();
$set->selectby($sessPersonalToken, "jenisdokumen", $arrdata);
while($set->nextRow())
{
  $arrdata= [];
...
$arrjeniskelamin= [];
$set= new DataCombo();
$set->selectby($sessPersonalToken, "jeniskelamin", $arrdata);
while($set->nextRow())
{
  $arrdata= [];
...
$arrstatusaktif= array(
    array("id"=>"1", "text"=> "Hidup")
    , array("id"=>"2", "text"=> "Wafat")
);

// pakem data validasi
$arrparam= ["token"=>$sessPersonalToken, "vurl"=>"anak_json", "id"=>$reqId, "rowid"=>$reqRowId];
$set= new DataCombo();
...
$reqTempatLahir= $set->getField('TEMPAT_LAHIR'); $vTempatLahir= checkwarna($reqPerubahanData, 'TEMPAT_LAHIR');

$reqTanggalLahir= dateToPageCheck($set->getField('TANGGAL_LAHIR')); $vTanggalLahir= checkwarna($reqPerubahanData, 'TANGGAL_LAHIR', [date]);

$reqUsia= $set->getField('USIA'); $vUsia= checkwarna($reqPerubahanData, 'USIA');

$reqJenisKelamin= $set->getField('JENIS_KELAMIN'); $vJenisKelamin= checkwarna($reqPerubahanData, 'JENIS_KELAMIN', $arrjeniskelamin, array("id", "text"), $reqTempValidasiHapusId);

$reqStatusKeluarga= $set->getField('STATUS_KELUARGA'); $vStatusKeluarga= checkwarna($reqPerubahanData, 'STATUS_KELUARGA', $arrstatussdr, array("id", "text"), $reqTempValidasiHapusId);

$reqStatusAktif= $set->getField('STATUS_AKTIF'); $vStatusAktif= checkwarna($reqPerubahanData, 'STATUS_AKTIF', $arrstatusaktif, array("id", "text"), $reqTempValidasiHapusId);

$reqStatusNikah= $set->getField('STATUS_NIKAH');

$reqStatusBekerja= $set->getField('STATUS_BEKERJA'); $vStatusBekerja= checkwarna($reqPerubahanData, 'STATUS_BEKERJA', $arrstatuskrj, array("id", "text"), $reqTempValidasiHapusId);

$reqDapatTunjangan= $set->getField('STATUS_TUNJANGAN');

$reqPendidikanId= $set->getField('PENDIDIKAN_ID'); $vPendidikanId= checkwarna($reqPerubahanData, 'PENDIDIKAN_ID', $arrpendidikan, array("id", "text"), $reqTempValidasiHapusId);

$reqPekerjaan= $set->getField('PEKERJAAN'); $vPekerjaan= checkwarna($reqPerubahanData, 'PEKERJAAN');

$reqAwalBayar= dateToPageCheck($set->getField('AWAL_BAYAR')); $vTanggalMeninggal= checkwarna($reqPerubahanData, 'TANGGAL_MENINGGAL', [date]);

$reqAkhirBayar= dateToPageCheck($set->getField('AKHIR_BAYAR')); $vTanggalMeninggal= checkwarna($reqPerubahanData, 'TANGGAL_MENINGGAL', [date]);

$reqSuamiIstriId= $set->getField('SUAMI_ISTRI_ID'); $vSuamiIstriId= checkwarna($reqPerubahanData, 'SUAMI_ISTRI_ID', $arrsuamiistri, array("id", "text"), $reqTempValidasiHapusId);

$reqSuamiIstri= $set->getField('SUAMI_ISTRI_NAMA');

$reqNoInduk= $set->getField('NOMOR_INDUK'); $vNoInduk= checkwarna($reqPerubahanData, 'NOMOR_INDUK');
...
$reqGelarDepan= $set->getField('GELAR_DEPAN'); $vGelarDepan= checkwarna($reqPerubahanData, 'GELAR_DEPAN');

$reqGelarBelakang= $set->getField('GELAR_BELAKANG'); $vGelarBelakang= checkwarna($reqPerubahanData, 'GELAR_BELAKANG');

$reqAktaKelahiran= $set->getField('AKTA_KELAHIRAN'); $vAktaKelahiran= checkwarna($reqPerubahanData, 'AKTA_KELAHIRAN');

$reqJenisIdDokumen= $set->getField('JENIS_ID_DOKUMEN'); $vJenisIdDokumen= checkwarna($reqPerubahanData, 'JENIS_ID_DOKUMEN', $arrjenisiddokumen, array("id", "text"), $reqTempValidasiHapusId);

$reqAgamaId= $set->getField('AGAMA_ID'); $vAgamaId= checkwarna($reqPerubahanData, 'AGAMA_ID', $arragama, array("id", "text"), $reqTempValidasiHapusId);

$reqEmail= $set->getField('EMAIL'); $vEmail= checkwarna($reqPerubahanData, 'EMAIL');

$reqHp= $set->getField('HP'); $vHp= checkwarna($reqPerubahanData, 'HP');

$reqTelepon= $set->getField('TELEPON'); $vTelepon= checkwarna($reqPerubahanData, 'TELEPON');

$reqAlamat= $set->getField('ALAMAT');

$reqBpjsNo= $set->getField('BPJS_NO'); $vBpjsNo= checkwarna($reqPerubahanData, 'BPJS_NO');

$reqBpjsTanggal= dateToPageCheck($set->getField('BPJS_TANGGAL')); $vBpjsTanggal= checkwarna($reqPerubahanData, 'BPJS_TANGGAL', [date]);

$reqNpwpNo= $set->getField('NPWP_NO'); $vNpwpNo= checkwarna($reqPerubahanData, 'NPWP_NO');
...
$reqNipPns= $set->getField('NIP_PNS'); $vNipPns= checkwarna($reqPerubahanData, 'NIP_PNS');

$reqStatusLulus= $set->getField('STATUS_LULUS');

$reqKematianNo= $set->getField('KEMATIAN_NO'); $vKematianNo= checkwarna($reqPerubahanData, 'KEMATIAN_NO');
...
$reqAktaNikahNo= $set->getField('AKTA_NIKAH_NO'); $vAktaNikahNo= checkwarna($reqPerubahanData, 'AKTA_NIKAH_NO');
...
$reqAktaCeraiNo= $set->getField('AKTA_CERAI_NO'); $vAktaCeraiNo= checkwarna($reqPerubahanData, 'AKTA_CERAI_NO');
      ...
      <form class="needs-validation" id="ff" method="post" novalidate enctype="multipart/form-data">
          ...
          <div class="col-md-8 mb-8">
            <div class="form-row">
              <div class="col-md-6 mb-6">
                ...
                <input placeholder="" type="text" class="form-control <?=$warnaclass?> easyui-validatebox" required name="reqNama" id="reqNama" <?=$read?> value="<?=$reqNama?>" onKeyUp="return setreplacesinglequote(this);" />
              </div>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input placeholder="" type="text" class="form-control <?=$warnaclass?> easyui-validatebox" name="reqGelarBelakang" id="reqGelarBelakang" value="<?=$reqGelarBelakang?>" />
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col-md-3 mb-3">
                ...
                <input placeholder="" type="text" class="form-control <?=$warnaclass?> easyui-validatebox" required name="reqTempatLahir" id="reqTempatLahir" <?=$read?> value="<?=$reqTempatLahir?>" />
              </div>
              ...
              <div class="col-md-3 mb-3">
                <label for="reqUsia">
                  Usia
                  <?
                  $warnadata= $vUsia['data'];
                  $warnaclass= $vUsia['warna'];
                  if(!empty($warnadata))
                  {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                <input placeholder="" disabled type="text" class="form-control <?=$warnaclass?> easyui-validatebox" id="reqUsia" value="<?=$reqUsia?>" />
              </div>
            </div>

            <div class="form-row">
              <div class="col-md-6 mb-6">
                <label for="reqStatusKeluarga">
                  Status Keluarga
                  <?
                  $warnadata= $vStatusKeluarga['data'];
                  $warnaclass= $vStatusKeluarga['warna'];
                  if(!empty($warnadata))
                  {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                <select class="form-control <?=$warnaclass?>" <?=$disabled?> name="reqStatusKeluarga" id="reqStatusKeluarga">
                  <option value=""></option>
                  <?
              ...
              <div class="col-md-6 mb-6">
                <label for="reqSuamiIstriId">
                  Nama Bapak / Ibu
                  <?
                  $warnadata= $vSuamiIstriId['data'];
                  $warnaclass= $vSuamiIstriId['warna'];
                  if(!empty($warnadata))
                  {
                  ?>
                  <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
                ...
                <select class="form-control <?=$warnaclass?>" <?=$disabled?> name="reqSuamiIstriId" id="reqSuamiIstriId">
        ...
        <div class="form-row">
          <div class="col-md-4 mb-4">
            ...
            <input placeholder="" type="text" class="form-control <?=$warnaclass?> easyui-validatebox" name="reqAktaKelahiran" id="reqAktaKelahiran" <?=$read?> value="<?=$reqAktaKelahiran?>" />
          </div>
        ...
        <div class="form-row">
          ...
          <div class="col-md-2 mb-2">
            ...
            <select class="form-control <?=$warnaclass?>" <?=$disabled?> name="reqStatusBekerja" id="reqStatusBekerja">
              <?
              foreach ($arrstatuskrj as $key => $value)
              {
                $optionid= $value["id"];
                $optiontext= $value["text"];
                $optionselected= "";
                if($reqStatusBekerja == $optionid)
                  $optionselected= "selected";
              ?>
                <option value="<?=$optionid?>" <?=$optionselected?>><?=$optiontext?></option>
              <?
        ...
        <div class="form-row">
          <div class="col-md-2 mb-2">
            <label for="reqStatusAktif">
              Status Hidup
              <?
              $warnadata= $vStatusAktif['data'];
              $warnaclass= $vStatusAktif['warna'];
              if(!empty($warnadata))
              {
              ?>
              <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
            ...
            <select class="form-control <?=$warnaclass?>" <?=$disabled?> name="reqStatusAktif" id="reqStatusAktif">
              <?
              foreach ($arrstatusaktif as $key => $value)
              {
                $optionid= $value["id"];
                $optiontext= $value["text"];
                $optionselected= "";
                if($reqStatusAktif == $optionid)
                  $optionselected= "selected";
              ?>
                <option value="<?=$optionid?>" <?=$optionselected?>><?=$optiontext?></option>
              <?
        ...
        <div class="form-row">
          <div class="col-md-2 mb-2">
            <label for="reqJenisKawinId">
              Status Pernikahan
              <?
              $warnadata= $vJenisKawinId['data'];
              $warnaclass= $vJenisKawinId['warna'];
              if(!empty($warnadata))
              {
              ?>
              <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
            ...
            <select class="form-control <?=$warnaclass?>" <?=$disabled?> name="reqJenisKawinId" id="reqJenisKawinId">
              <option value=""></option>
            </select>
          </div>
        ...
        <div class="form-row">
          ...
          <div class="col-md-2 mb-2">
            <label class="active" for="reqAwalBayar">
              Mulai Dibayar
              <?
              $warnadata= $vAwalBayar['data'];
              $warnaclass= $vAwalBayar['warna'];
              if(!empty($warnadata))
              {
              ?>
              <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
            ...
            <table>
              <tr> 
                <td style="padding: 0px;">
                  <input placeholder="" class="form-control <?=$warnaclass?> easyui-validatebox formattanggalnew" data-options="validType:'dateValidPicker'" type="text" name="reqAwalBayar" id="reqAwalBayar" value="<?=$reqAwalBayar?>" maxlength="10" onKeyDown="return format_date(event,'reqAwalBayar');" />
                </td>
                <td style="padding: 0px;">
          ...
          <div class="col-md-2 mb-2">
            <label class="active" for="reqAkhirBayar">
              Akhir Dibayar
              <?
              $warnadata= $vAkhirBayar['data'];
              $warnaclass= $vAkhirBayar['warna'];
              if(!empty($warnadata))
              {
              ?>
              <span aria-label="<?=$warnadata?>" class="tooltip-red" data-balloon-pos="up"><i class="fa fa-question-circle"></i></span>
            ...
            <table>
              <tr> 
                <td style="padding: 0px;">
                  <input placeholder="" class="form-control <?=$warnaclass?> easyui-validatebox formattanggalnew" data-options="validType:'dateValidPicker'" type="text" name="reqAkhirBayar" id="reqAkhirBayar" value="<?=$reqAkhirBayar?>" maxlength="10" onKeyDown="return format_date(event,'reqAkhirBayar');" />
                </td>
                <td style="padding: 0px;">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?
              ...
              {
            ?>
              <button class="btn btn-danger" type="button" onclick="hapusdata('<?=$reqTempValidasiId?>', 'anak', '', '<?=$linkfilenamekembali?>')">Batal</button>
            <?
              }
            }
            }
