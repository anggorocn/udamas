        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input type="text" class="form-control formattanggalnew" id="reqTanggalSelesai" placeholder="Isikan Tanggal Selesai Menjabat" onKeyDown="return format_date(event,'reqTanggalSelesai');" name="reqTanggalSelesai"  placeholder="Isikan Tanggal BPJS" value="<?=$reqTanggalSelesai?>">
