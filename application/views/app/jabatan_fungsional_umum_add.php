        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
                ...
                <input type="hidden" name="reqJabatanFuId" id="reqJabatanFuId" value="<?=$reqJabatanFuId?>" /> 
                  <input placeholder="Isikan Nama Jabatan" type="text" id="reqJabatanFu" name="reqNama" <?=$read?> value="<?=$reqNama?>" class="easyui-validatebox form-control"  required />
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input type="text" class="form-control formattanggalnew" id="reqTanggalSelesai" placeholder="Isikan Tanggal Selesai Menjabat" onKeyDown="return format_date(event,'reqTanggalSelesai');" name="reqTanggalSelesai"  placeholder="Isikan Tanggal BPJS"  readonly value="<?=$reqTanggalSelesai?>">


          </div>
          <label class="control-label col-sm-2" for="">Lama Menjabat (tahun):</label>
          <div class="col-sm-4">
            <input type="text" class="form-control" id="reqLamaMenjabat" name="reqLamaMenjabat" readonly placeholder="Isikan Lama Menjabat" value="<?=$reqLamaMenjabat?>">
          </div>
        </div>
          <div class="form-group">
          <label class="control-label col-sm-2" for="">Nilai Rekam Jejak:</label>
          <div class="col-sm-4">
            <input type="text" class="form-control easyui-validatebox" id="reqNilaiRekam" name="reqNilaiRekam" readonly  placeholder="Isikan Nilai Rekam Jejak" value="<?=$reqNilaiRekam?>">
          </div>
...
<script type="text/javascript">
  ...
  //  $('input[id^="reqPejabatPenetap"], input[id^="reqNama"]').autocomplete({
       $('input[id^="reqPejabatPenetap"],  input[id^="reqJabatanFu"],input[id^="reqNama"]').each(function(){
        $(this).autocomplete({
      source:function(request, response){
        ...
        else if (id.indexOf('reqNama') !== -1)
        {
          ...
          urlAjax= "api/combo/namajabatan?reqTanggalBatas="+reqTanggalBatas+"&reqTipeJabatanId=x2";
        }
