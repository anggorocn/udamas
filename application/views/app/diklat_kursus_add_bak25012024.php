      ...
      <form class="needs-validation"  id="ff" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control <?=$warnaclass?>" placeholder="" name="reqNoSertifikat" id="reqNoSertifikat" <?=$read?> value="<?=$reqNoSertifikat?>" />
          </div>
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control formattanggalnew <?=$warnaclass?>" placeholder="" name="reqTglSertifikat" id="reqTglSertifikat" <?=$read?> maxlength="10" onKeyDown="return format_date(event,'reqTglSertifikat');" value="<?=$reqTglSertifikat?>" />
          </div>
          <div class="col-md-3 mb-3">
        ...
        <div class="form-row">
          <div class="col-md-3 mb-3">
            ...
            <input type="text" class="form-control <?=$warnaclass?>" placeholder="" name="reqJumlahJam" id="reqJumlahJam" <?=$read?> value="<?=$reqJumlahJam?>" />
          </div>
          <div class="col-md-3 mb-3">
        ...
        <div class="form-row">
          ...
          <div class="col-md-3 mb-3" id="labelrumpunselect">
            ...
            <input placeholder="" type="text" disabled class="form-control" id="reqRumpunNamaKompetensi" value="<?=$reqRumpunJabatanNama?>" />
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="col-md-12 mb-12">
            ...
            <input type="text" class="form-control <?=$warnaclass?>" placeholder="" name="reqRefInstansi" id="reqRefInstansiCari" <?=$read?> value="<?=$reqRefInstansi?>" />
          </div>
        </div>
