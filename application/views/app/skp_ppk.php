...
$arrtabledata= array(
    ...
    , array("label"=>"Pejabat Penilai", "field"=> "PEGAWAI_PEJABAT_PENILAI_NAMA", "display"=>"", "width"=>"")
...
$arrparam= ["token"=>$sessPersonalToken, "vurl"=>"Penilaian_skp_json"];
$set= new DataCombo();
  ...
  <div class="col-md-12">
    ...
    <div class="area-panel">
      ...
      <div class="inner">
        ...
        <button type="button" onclick='document.location.href="app/index/skp_ppk_add?reqId=baru"' class="btn btn-xs btn-info">Tambah</button>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            while($set->nextRow())
            {
              $reqId= $set->getField("PENILAIAN_SKP_ID");
