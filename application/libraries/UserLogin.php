...
************************************************************************/
  ...
  class UserLogin{
    ...
    function UserLogin(){
		...
		session_register("ssUsr_userNRP");
    ...
    function emptyUsrSessions(){
		...
		$_SESSION["ssUsr_jabatan"] = "";
		$_SESSION["ssUsr_cabang"] = "";
		$_SESSION["ssUsr_cabangP3Id"] = "";
		$_SESSION["ssUsr_perusahaanId"] = "";
		$_SESSION["ssUsr_perusahaanCabangId"] = "";
    ...
    function setProps(){
		...
		$this->jabatan = $_SESSION["ssUsr_jabatan"];
		$this->cabang = $_SESSION["ssUsr_cabang"];
		$this->cabangP3Id = $_SESSION["ssUsr_cabangP3Id"];
		
		$this->perusahaanId = $_SESSION["ssUsr_perusahaanId"];
		$this->perusahaanCabangId = $_SESSION["ssUsr_perusahaanCabangId"];
		...
		$this->userNRP = $_SESSION["ssUsr_userNRP"];
    ...
    function verifyUserLogin($usrLogin,$password){			
		...
		if($usr->firstRow()){
			...
			$_SESSION["ssUsr_cabangP3Id"] = $usr->getField("CABANG_P3_ID");
			...
			$_SESSION["ssUsr_userAksesRekrutmen"] = $usr->getField("AKSES_APP_REKRUTMEN");	
    ...
    function checkUserLogin(){
		...
		if (!$usr->firstRow() || $_SESSION["ssUsr_idUser"] == "") {
			$statusLogin = false;
		} else {
			$statusLogin = true;
		}
