...
class Penilaian_skp_detil_json extends CI_Controller {
	...
	function add()
	{
		...
		$data= array(
			...
			, 'reqTriwulan'=>$reqTriwulan
			, 'reqKuadratPredikatKinerja'=>$reqKuadratPredikatKinerja
			, 'reqCapaianOrganisasi'=>$reqCapaianOrganisasi

		);

		$set= new DataCombo();
		$response= $set->updatepersonal("Penilaian_detail_skp_json", $data);
